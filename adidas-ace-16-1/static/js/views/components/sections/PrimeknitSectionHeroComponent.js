define([
    ...
    return SectionBaseComponent.extend({
        ...
        _activate: function() {
            ...
            if(this._productPages.length <= 1) {
                 this._transitionIn.play(0);
            } else {
                this._transitionIn.progress(1).stop();
            }
        ...
        _setupTransitionIn: function() {
            ...
            this._transitionIn.add(this._showButton, 0.4);
            this._transitionIn.fromTo(this.ui.hero_content_title, 0.4, {autoAlpha:0}, {autoAlpha:1, ease:Linear.easeNone}, 0.4);

            this._transitionIn.add(this._showScrollIndicator, 1);
        },
        ...
        _scroll: function() {
            if(this._productPages.length > 1 && this.getScrollPos() < this.getSectionContentHeight() && this.getScrollPos() >= 0) {
